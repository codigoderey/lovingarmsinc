  ...
  const [isVideoOpen, setIsVideoOpen] = useState(false)
   ...
   return (
			<div className="testimonials-area-three py-120 rel z-1">
					...
					<div className="row justify-content-center">
						<div className="col-xl-6 col-lg-8 col-md-10">
							<div className="section-title text-center mb-30">
								...
								<h3>
									Touched with <span>Loving Arms</span> clients
								</h3>
								<p>
									Here is to your success! Our served community have some words
									to share.
								</p>
							</div>
						</div>
							...
							.map((item) => (
								<div key={item.id} className="col-xl-4 col-md-6">
									<div className={`testimonial-item-three ${item.item_bg} `}>
										...
										<div className="icon">
											<Image src={item.quote_icon || ""} alt="Quote" />
										</div>
									</div>
								</div>
							))}
				...
				<div
					className="testimonials-bg bgs-cover"
					style={{
